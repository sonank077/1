...
async function req(){
        ...
        var data = '?' + cryptoRandomString.generate({length: 1, characters: 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'}) + '=' + cryptoRandomString.generate({length: 8}) + cryptoRandomString.generate({length: 1, characters: '|='}) + cryptoRandomString.generate({length: 8}) + cryptoRandomString.generate({length: 1, characters: '|='}) + cryptoRandomString.generate({length: 8})+ '&' + cryptoRandomString.generate({length: 1, characters: 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'}) +'=' + cryptoRandomString.generate({length: 8}) + cryptoRandomString.generate({length: 1, characters: '|='}) + cryptoRandomString.generate({length: 8}) + cryptoRandomString.generate({length: 1, characters: '|='}) + cryptoRandomString.generate({length: 8});
        var options = {
            method: randommethod,
